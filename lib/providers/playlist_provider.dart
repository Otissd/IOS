...
//audio player
  ...
  static const String _baseUrl = 'http://localhost:8080/api/public/files/download/audio/d5629224-fb04-44a8-8cd6-4a52022fc3a5.mp3';
...
Future<void> play() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await _audioPlayer.play(BytesSource(response.bodyBytes)); // Use bytes directly
        _isPlaying = true;
      } else {
